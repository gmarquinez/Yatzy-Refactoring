...
def test_chance_scores_sum_of_all_dice(listaDeDados, resultado):
        assert Yatzy.chance(listaDeDados) == resultado 
...
def test_yatzy_scores_50(listaDeDados, resultado):
        assert Yatzy.yatzy(listaDeDados) == resultado
